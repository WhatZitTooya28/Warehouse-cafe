...
<head>
    ...
    <title>Manajemen Barang - {{ config('app.name', 'Laravel') }}</title>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div class="w-full sm:w-auto flex items-center gap-4">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Cari Nama/ID Barang..." class="w-full sm:w-64 pl-10 pr-4 py-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <select class="px-4 py-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option disabled selected>Kategori</option>
                            {{-- Opsi kategori akan diisi secara dinamis nanti --}}
                        </select>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                {{-- Loop Data Barang akan dimulai di sini --}}
                                {{-- Contoh data statis --}}
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    <td class="px-6 py-4">1</td>
                                    <td class="px-6 py-4 font-medium text-gray-900">ARD0006</td>
                                    <td class="px-6 py-4">Biji Kopi Arabika (Brasil Santos)</td>
                                    <td class="px-6 py-4">Bahan Baku</td>
                                    <td class="px-6 py-4"><span class="bg-yellow-200 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-full">10</span></td>
                                    <td class="px-6 py-4">Kg</td>
                                    <td class="px-6 py-4">Rak A1</td>
                                    <td class="px-6 py-4">01 - 07 - 2025</td>
                    ...
                    <div class="mt-4">
                        {{-- Link paginasi akan muncul di sini --}}
                    </div>
                </div>
            </main>
        </div>
