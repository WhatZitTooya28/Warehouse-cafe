    ...
    <div class="p-6 bg-blue-600 text-white rounded-lg shadow-md mb-8">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-sm text-blue-100">Isi form di bawah ini untuk menambahkan data supplier baru.</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('supplier.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="id_supplier" id="id_supplier" value="{{ old('id_supplier') }}" required class="w-full px-4 py-2 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label for="nama_supplier" class="block text-sm font-medium text-gray-700 mb-1">Nama Supplier</label>
                    <input type="text" name="nama_supplier" id="nama_supplier" value="{{ old('nama_supplier') }}" required class="w-full px-4 py-2 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full px-4 py-2 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label for="tanggal_kerjasama" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kerjasama</label>
                    <input type="date" name="tanggal_kerjasama" id="tanggal_kerjasama" value="{{ old('tanggal_kerjasama') }}" required class="w-full px-4 py-2 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
