...
<head>
    ...
    <title>Manajemen Supplier - {{ config('app.name', 'Laravel') }}</title>
...
<body class="bg-gray-100 antialiased">
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-gray-200">
        {{-- UNTUK KONSISTENSI, SALIN KODE <aside> DARI dashboard.blade.php ANDA KE SINI --}}
            ...
            <header class="flex justify-between items-center p-4 sm:p-6 bg-white border-b-2 border-gray-200">
                <div class="flex items-center">
                    <button @click="sidebarOpen = !sidebarOpen" class="text-gray-500 focus:outline-none md:hidden">
                        <svg class="h-6 w-6" viewBox="0 0 24 24"><path d="M4 6H20M4 12H20M4 18H11"></path></svg>
                    </button>
                </div>
                <div class="flex items-center">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div class="w-full sm:w-auto flex items-center gap-4">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Cari Nama/ID Supplier..." class="w-full sm:w-64 pl-10 pr-4 py-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
