...
<head>
    ...
    <title>Transaksi Barang Keluar - {{ config('app.name', 'Laravel') }}</title>
                ...
                <div class="p-6 bg-blue-600 text-white rounded-lg shadow-md mb-8">
                    <div class="flex items-center space-x-4">
                        <div class="p-3 bg-white/20 rounded-full">
                            <i class="fa-solid fa-truck-ramp-box w-8 h-8 text-2xl"></i>
                        </div>
                        <div>
                            <h1 class="text-2xl font-bold">Barang Keluar</h1>
                            <p class="text-sm text-blue-100">Mencatat dan mengelola setiap barang yang keluar dari gudang.</p>
                        </div>
                    </div>
                </div>
