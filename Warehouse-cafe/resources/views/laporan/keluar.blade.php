...
<head>
    ...
    <title>Laporan Barang Keluar - {{ config('app.name', 'Laravel') }}</title>
  ...
  <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="w-64 bg-[#2D3748] text-white flex flex-col fixed inset-y-0 left-0 transform transition duration-300 ease-in-out md:relative md:translate-x-0 z-30">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4 sm:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
                        <div class="p-3 bg-purple-100 rounded-full"><i class="fa-solid fa-user-tag text-2xl text-purple-500"></i></div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">{{-- Kolom Tujuan/Penerima --}}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="8" class="text-center py-4">Tidak ada data barang keluar.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
