...
<html lang="id">
<head>
    {{-- Salin semua isi <head> dari file dashboard.blade.php Anda --}}
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Laporan Barang Masuk - {{ config('app.name', 'Laravel') }}</title>
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4 sm:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
                        ...
                        <div><p class="text-sm font-medium text-gray-500">Total Transaksi Masuk</p><p class="text-2xl font-bold text-gray-800">{{ $totalTransaksi }}</p></div>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
                        <div class="p-3 bg-orange-100 rounded-full"><i class="fa-solid fa-truck text-2xl text-orange-500"></i></div>
                        <div><p class="text-sm font-medium text-gray-500">Total Barang Masuk (Unit)</p><p class="text-2xl font-bold text-gray-800">{{ $totalUnit }}</p></div>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
                        <div class="p-3 bg-blue-100 rounded-full"><i class="fa-solid fa-user-tag text-2xl text-blue-500"></i></div>
                        <div><p class="text-sm font-medium text-gray-500">Total Nilai Barang Masuk</p><p class="text-2xl font-bold text-gray-800">Rp {{ number_format($totalNilai, 0, ',', '.') }}</p></div>
                    </div>
                </div>

                <!-- Tabel Data Laporan Barang Masuk -->
